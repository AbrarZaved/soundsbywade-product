...
export function TermsPage() {
    ...
    useEffect(() => {
        document.title = "Terms of Service - Orbital Fitness";
        fetch("/api/v1/superadmin/public/legal/terms_and_conditions/")
            .then((res) => {
                        ...
                        <div className="text-center mb-16">
                            <div className="flex justify-center mb-6">
                                <div className="relative">
                                    ...
                                    <FileText className="relative w-16 h-16 text-[#6CFFF3]" />
                                </div>
                            </div>
                        ...
                        <div className="relative">
                            ...
                            <div className="relative backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-8 md:p-12">
                                {loading ? (
                                    ...
                                    <p className="text-white/50 text-center py-20">Unable to load Terms of Service. Please try again later.</p>
                                ) : (
